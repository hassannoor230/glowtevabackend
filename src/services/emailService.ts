...
class EmailService {
  ...
  async sendNewsletterWelcome(subscriberEmail: string, adminEmail: string): Promise<boolean> {
    const userHtml = `
      <!DOCTYPE html>
      <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Explore our <a href="${config.clientUrl}/shop" style="color: #C5A46E;">latest collections</a> or read our <a href="${config.clientUrl}/journal" style="color: #C5A46E;">journal</a> for skincare tips.</p>
            </div>
            <div class="gold-line"></div>
            <div class="footer">
              With botanical care,<br>The GlowTeva Team
  ...
  async sendNewsletterAdminNotification(subscriberEmail: string): Promise<boolean> {
    const adminHtml = `
      <!DOCTYPE html>
      <html>
        <head>
